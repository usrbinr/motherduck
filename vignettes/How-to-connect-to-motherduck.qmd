...
subtitle: "Guide to creating a motherduck account, service token and establishing a local connection"
...
1. Go to [motherduck](https://motherduck.com/) and create an account, there are free options are available
...
5. To save this token in your R environment, simply leverage the [usethis](https://usethis.r-lib.org/) function `usethis::edit_r_environ()` to assign and save this (one time effort)
